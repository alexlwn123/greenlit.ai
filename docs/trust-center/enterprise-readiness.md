...
| 5 | Secure SDLC and vulnerability management | CI, tests, CodeQL, Dependabot, input controls, and a disclosure channel exist | Remediation SLA metrics, SBOM, artifact signing/provenance, protected releases, annual third-party test |
