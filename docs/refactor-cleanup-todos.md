...
### 2. Standardize `data/Notices` path casing
...
### 3. Clarify Pinecone vs ChromaDB
...
### 4. Convert to a true pnpm workspace monorepo
...
### 8. Add one frontend smoke test or at least clean lint
...
### 10. Bind jobs/results to a user or session before production use
...
### 11. Tighten CORS and deployment assumptions
...
### 12. Make result retention explicit
...
### 13. Separate app code from generated corpus/data
...
### 14. Remove stale starter assets and docs
...
### 15. Add a short architecture map
...
### 16. Audit, archive, or delete stale docs and instruction files
...
### 17. Consolidate generated artifacts and scratch files
...
### 18. Add lightweight repo conventions
